                    ...
                    <div className="flex flex-col justify-center space-y-4 text-center" >
                        ...
                        <div className="w-full max-w-sm space-y-2 mx-auto" >
                            <form className="flex space-x-2" onSubmit={subscribe} >
                                ...
                                />
                                <button type="submit" className="bg-green-600 text-white w-auto px-4 py-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 rounded-full">
                                ✨ Subscribe
                                </button>
                            </form>
                            {state === 'Error' && (
                                ...
                                {state === 'Success' && (
                                    <p className="error-state text-green-500">Awesome, you've been subscribed!</p>
                                )}
